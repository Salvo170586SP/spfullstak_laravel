<x-app-layout>
    <div class="container mx-auto py-4">
        <div class="flex flex-col">
            ...
            <div class="col" >
                <div class="max-w-xxl py-4 px-8 bg-white shadow-lg rounded-lg my-20" style="height: 400px; overflow: auto">
                    <span class="text-1xl font-bold text-black">Modifiche Applicate</span>
                    <hr>
                    <div class="py-5">
